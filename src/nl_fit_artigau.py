...
class nl():
    def __init__(self,f=''):
        '''
            ls: list of reads
        '''
        self.tmpdir = '/nirps_raw/nirps/characterization/.tmp'
    ...
    def make_report(self,nonlinf='nonlin.fits',cpath='/nirps_raw/nirps/characterization',sbias='superbias220517095751.fits'):
...
if '__main__' in __name__:
    ...
    path = '/nirps_raw/nirps/characterization'
    path_tmp = '/nirps_raw/nirps/characterization/.tmp'
